# FILE: backend/scripts/test_nyc_adapter.py
# ROLE: Standalone script to test the NYC 311 Adapter by fetching and displaying recent complaints.
...
try:
    ...
    try:
        from backend.app.services.city_adapters.nyc import NYCAdapter
    except ImportError:
...
async def main():
    print("Initializing NYC 311 Adapter...")
    adapter = NYCAdapter()
    ...
    print("="*80)
    print(f"Fetched {len(complaints)} complaints successfully")
