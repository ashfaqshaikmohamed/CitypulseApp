# FILE: backend/scripts/test_sf_adapter.py
# ROLE: Standalone script to test the SF 311 Adapter by fetching and displaying recent complaints.
...
try:
    ...
    try:
        from backend.app.services.city_adapters.sf import SFAdapter
    except ImportError:
...
async def main():
    print("Initializing SF 311 Adapter...")
    adapter = SFAdapter()
    ...
    print("="*80)
    print(f"Fetched {len(complaints)} complaints from SF successfully")
